...
|------|--------------|-------------|
| **Ask** | Read files, analyze code, generate plans, answer questions | Cannot create/modify files, cannot run Git commands, cannot create branches or commit |
| **Edit** | All Ask capabilities plus: create/modify files, run terminal commands, execute Git operations | Full read-write access to workspace |
