...
{
    public static CustomerDto ToDto(this Entities.Customers entity)
    {
    ...
    public static Entities.Customers ToEntity(this CreateCustomerDto dto)
    {
    ...
    public static void ApplyTo(this CustomerDto dto, Entities.Customers entity)
    {
